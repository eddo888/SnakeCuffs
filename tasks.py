...
def build_cffi(c):
    ...
    if True:
        install_name_tool(
            dependent='cffi_example.cpython-38-darwin.so',
            depends=[
                'libcmult.so'
            ],
        )
...
def build_cppmult(c):
    ...
    if True:
        install_name_tool(
            dependent='libcppmult.so',
            depends=[
                'libcmult.so',
                'cffi_example.cpython-38-darwin.so',
            ]
        )
...
def compile_python_module(cpp_name, extension_name):
	# updated for python3.8 and mac compiliation on missing symbols
    invoke.run(
...
def build_pybind11(c):
    ...
    if True:
        install_name_tool(
            dependent='pybind11_example.cpython-38-darwin.so',
            depends=[
                'libcmult.so',
                'cffi_example.cpython-38-darwin.so',
                'libcppmult.so',
...
def build_cython(c):
    ...
    if True:
        install_name_tool(
            dependent='cython_example.cpython-38-darwin.so',
            depends=[
                'libcmult.so',
                'cffi_example.cpython-38-darwin.so',
                'libcppmult.so',
